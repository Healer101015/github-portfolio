    ...
    <div className="relative min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-emerald-500/30 overflow-hidden cursor-none md:cursor-auto">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-slate-950/80 backdrop-blur-lg border-b border-slate-800/50 shadow-xl py-3' : 'bg-transparent py-5'}`}>
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          <a href="#" className="text-2xl font-bold tracking-tighter group z-10 glitch-hover">
            <span className="text-white">J</span><span className="text-emerald-400">H.</span>
          </a>
      ...
      <section className="relative pt-32 pb-20 px-6 min-h-screen flex flex-col justify-center items-start max-w-6xl mx-auto z-10">
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl relative z-10">
          ...
          <h1 className="text-6xl md:text-8xl font-extrabold mb-2 tracking-tight text-white">João Henrique.</h1>
          ...
          <p className="text-lg text-slate-400 leading-relaxed max-w-2xl mb-12">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Desenvolvedor apaixonado por interfaces impecáveis e sistemas robustos. Transformo lógica complexa em experiências fluidas e elegantes.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-16 items-center">
            <div className="md:col-span-2 text-slate-400 space-y-6 text-lg leading-relaxed">
              <p>Olá! O meu nome é João Henrique. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in dui mauris.</p>
              <p>Trabalhar com código é a arte de criar soluções através da lógica e da criatividade. O meu foco diário é construir produtos e experiências digitais fantásticas.</p>
            </div>
                ...
                <div className="p-6 font-mono text-sm md:text-base text-emerald-400/90">
                  <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{ visible: { transition: { staggerChildren: 0.1 } } }}>
                    ...
                    {[
                      ...
                      <p className="ml-6">name: <span className="text-yellow-300">'João Henrique'</span>,</p>,
                      <p className="ml-6">role: <span className="text-yellow-300">'Fullstack Developer'</span>,</p>,
                      <p className="ml-6">skills: [<span className="text-yellow-300">'TypeScript'</span>, <span className="text-yellow-300">'React'</span>],</p>,
      ...
      <section id="contato" className="py-32 px-6 text-center z-10 relative">
        <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="max-w-2xl mx-auto flex flex-col items-center relative">
          ...
          <div className="flex gap-4">
            <MagneticButton href="mailto:joaohenrique@exemplo.com" className="px-10 py-5 bg-white text-slate-900 font-bold font-mono text-sm rounded-md shadow-[0_0_20px_rgba(255,255,255,0.1)]">
              Dizer Olá
            </MagneticButton>
          </div>
        </motion.div>
